...
<!--<%	If objDevice(13) = "Laptop" Or objDevice(13) = "Desktop" Or objDevice(13) = "Access Point" Then %>
	...
	<div>
		<div class="Button"><input type="image" src="../images/save.png" width="20" height="20" title="Update Device" onmouseover="setSubmitValue('Update Device')" onmouseout="setSubmitValue('')" /></div>
	</div>
